 ...
 * number 3 and 2 refer to octaves. It is arranged in the order of highest note first.
...
const rowLabels = el("div", "row-labels"); // container for note lables
